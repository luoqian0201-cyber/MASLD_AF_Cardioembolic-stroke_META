...
tiff("figures/Figure6_AF_attenuation.tiff",
...
dev.off()
message("Figure 6: figures/Figure6_AF_attenuation.tiff")
...
# Draw Figure 7
# ============================================================
tiff("figures/Figure7_fibrosis_severity_dynamics.tiff",
...
dev.off()
message("Figure 7: figures/Figure7_fibrosis_severity_dynamics.tiff")
